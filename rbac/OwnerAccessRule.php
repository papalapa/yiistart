<?php
    ...
    class OwnerAccessRule extends Rule
    {
        ...
        public function execute($user, $item, $params)
        {
            ...
            if (BaseUser::isGuest() || BaseUser::identity()->role < BaseUser::ROLE_AUTHOR) {
                return false;
            }
            ...
            return (!isset($attribute) && BaseUser::identity()->role > BaseUser::ROLE_MANAGER)
                   // иначе, атрибут владельца должен совпадать
                   || strcmp(BaseUser::identity()->id, $attribute) === 0;
        }
    }
