    ...
    class m170503_113530_create_pages_table extends Migration
    {
        ...
        public function up()
        {
            ...
            $this->createTable('{{pages}}', [
                ...
                'has_text'    => $this->boolean()->unsigned()->defaultValue(false),
                'context'     => $this->text()->defaultValue(null),
                'has_context' => $this->boolean()->unsigned()->defaultValue(false),
                'image'       => $this->string(128)->defaultValue(null),
                'has_image'   => $this->boolean()->unsigned()->defaultValue(false),
